...
public class SampleTesting1DomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SampleTesting1GlobalFeatureConfigurator.Configure();
        SampleTesting1ModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SampleTesting1DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SampleTesting1Resource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SampleTesting1");

            options.DefaultResourceType = typeof(SampleTesting1Resource);
        ...
        {
            options.MapCodeNamespace("SampleTesting1", typeof(SampleTesting1Resource));
        });
    }
}
