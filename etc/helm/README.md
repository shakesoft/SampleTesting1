...
```
127.0.0.1 sampletesting1-local-web
127.0.0.1 sampletesting1-local-webgateway
127.0.0.1 sampletesting1-local-authserver
```
...
Now, you can browse the URL: `https://sampletesting1-local-web`
